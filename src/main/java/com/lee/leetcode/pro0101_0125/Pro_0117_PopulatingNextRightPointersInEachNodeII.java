 ...
 *
 */
public class Pro_0117_PopulatingNextRightPointersInEachNodeII {

    public static void main(String[] args) {
        Integer[] array = {1,2,3,4,5,null,7};
    ...
    public static void connect(TreeLinkNode root) {
        Pro_0116_PopulatingNextRightPointersInEachNode.connect(root);
    }
}
